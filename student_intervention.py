...
X_train, X_test, y_train, y_test = train_test_split(X_all, y_all, test_size=0.24, random_state=42)#, stratify=y_all)
...
#ssscv = cross_validation.StratifiedShuffleSplit( y_train, n_iter=10, test_size=0.1)

# TODO: Make an f1 scoring function using 'make_scorer' 
f1_scorer = metrics.make_scorer(score_func=f1_score, pos_label="yes", greater_is_better=True)

# TODO: Perform grid search on the classifier using the f1_scorer as the scoring method
grid_obj = grid_search.GridSearchCV(estimator=clf, param_grid=parameters, scoring=f1_scorer)#,cv=ssscv)
